...
const PostDetail = () => {
  ...
  const tweet = useSelector((state) => state.postReducer.singlePost);
  let post ;
  if (post === undefined){
    post = tweet;
  }
...
//   console.log("post ksjdfh")
  ...
  const comments = useSelector((state) => state.postCommentReducer.commentList);
  console.log(comments + "asdxx")
...
//   console.log("before use effect")
  useEffect(() => {
    ...
    dispatch(post_detail(uuid)); 
    dispatch(post_comments(uuid)); 
}, [dispatch, uuid]);
//   useEffect(() => {
...
//   useEffect(() => {
//     post_detail(uuid)
//     console.log('running post detail useeffect')
...
//   }, []);
  ...
  const commentAdd = () => {
    dispatch(addPostComment(uuid, commentInput));
    setCommentInput("");
  };
...
//         const res = await axiosInstance.get(`${url}community/detail/${uuid}`);
//         console.log(res.data)
//         console.log("kkkjjjjhhh")
//       }
//       await axios.get(`${url}community/detail/${uuid}`);
//     } catch (err) {
